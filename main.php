...
function getproblist_by_lesson($lesson_id=0,$isadmin=0)
{
  ...
  //lasted modify was here
  $sql2 = "SELECT flag FROM lessons WHERE id = '".$lesson_id."'";
  $flag = mysql_query($sql2);
  $flag = mysql_result($flag,0,'flag');
  //end of modify
  ...
  $sql = "SELECT DISTINCT lesson_prob.limit limit1, lessons.active, lessons.id, prob_info.prob_id, prob_info.name, description FROM lessons,prob_info,lesson_prob,deadline WHERE lessons.id = '".$lesson_id."' AND lessons.id = lesson_prob.lesson_id AND lesson_prob.prob_id = prob_info.prob_id AND lessons.id = deadline.lesson_id AND grp = '".$result."' AND (SELECT now()) < deadline.deadline AND lessons.active != '0'";
    ...
    <div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <!--li><a href="pwdform.php">change password</a></li-->
          <!--li><a href="getpwdform.html">Get password</a></li-->
